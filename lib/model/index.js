...
const ModelImpl = connection =>
	...
	class ModelBase {
		 ...
		 * @param {String} [autoSetTimeFields] used to define fields that should be automatically updated with a current timestamp default: ["updatedAt"]
		 */
		constructor(args) {
			const { tableName, pkName = "id", enumMapping, autoSetTimeFields } = args
			/**
			 * @member
			 ...
			 */
			this.autoSetTimeFields = autoSetTimeFields || ["updatedAt"]
			/**
			 * @member
